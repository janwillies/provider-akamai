...
func (in *PropertiesItems) DeepCopyInto(out *PropertiesItems) {
	*out = *in
	if in.Items != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PropertiesItems.
func (in *PropertiesItems) DeepCopy() *PropertiesItems {
	if in == nil {
		return nil
	}
	out := new(PropertiesItems)
	in.DeepCopyInto(out)
	return out
}
